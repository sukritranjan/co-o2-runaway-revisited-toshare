...
#    
    ...
    print('OH (base): {0:1.1e}'.format((np.sum(mr_z_s_base[:,ind_oh]*n_z_bulkatm_base)/np.sum(n_z_bulkatm_base))))
    print('OH (new): {0:1.1e}'.format((np.sum(mr_z_s_new[:,ind_oh]*n_z_bulkatm_new)/np.sum(n_z_bulkatm_new))))
    print('O (base): {0:1.1e}'.format((np.sum(mr_z_s_base[:,ind_o]*n_z_bulkatm_base)/np.sum(n_z_bulkatm_base))))
    print('O (new): {0:1.1e}'.format((np.sum(mr_z_s_new[:,ind_o]*n_z_bulkatm_new)/np.sum(n_z_bulkatm_new))))
    print('H (base): {0:1.1e}'.format((np.sum(mr_z_s_base[:,ind_h]*n_z_bulkatm_base)/np.sum(n_z_bulkatm_base))))
    print('H (new): {0:1.1e}'.format((np.sum(mr_z_s_new[:,ind_h]*n_z_bulkatm_new)/np.sum(n_z_bulkatm_new))))
    ...
    print('NO (base): {0:1.1e}'.format(mr_z_s_base[0,ind_no]))
    print('HNO4 (base): {0:1.1e}'.format(mr_z_s_base[0,ind_hno4]))
    print('SO2 (base): {0:1.1e}'.format(mr_z_s_base[0,ind_so2]))
    print('H2 (base): {0:1.1e}'.format(mr_z_s_base[0,ind_h2]))


    print('CO (new): {0:1.1e}'.format(mr_z_s_new[0,ind_co]))
    print('O2 (new): {0:1.1e}'.format(mr_z_s_new[0,ind_o2]))
    print('NO (new): {0:1.1e}'.format(mr_z_s_new[0,ind_no]))
    print('HNO4 (new): {0:1.1e}'.format(mr_z_s_new[0,ind_hno4]))
    print('SO2 (new): {0:1.1e}'.format(mr_z_s_new[0,ind_so2]))
    print('H2 (new): {0:1.1e}'.format(mr_z_s_new[0,ind_h2]))
    ...
    ax[0].plot(mr_z_s_base[:,ind_ho2], z_center_base, linewidth=2, linestyle=linestyles[0], color='yellow', label='HO2')
    ax[0].plot(mr_z_s_base[:,ind_h2o2], z_center_base, linewidth=2, linestyle=linestyles[0], color='orange', label='H2O2')
    ...
    ax[0].plot(mr_z_s_new[:,ind_ho2], z_center_new, linewidth=2, linestyle=linestyles[1], color='yellow')
    ax[0].plot(mr_z_s_new[:,ind_h2o2], z_center_new, linewidth=2, linestyle=linestyles[1], color='orange')
    ...
    ax[1].plot(mr_z_s_base[:,ind_n2o5], z_center_base, linewidth=2, linestyle=linestyles[0], color='mediumorchid', label='N2O5')
    ax[1].plot(mr_z_s_base[:,ind_hno4], z_center_base, linewidth=2, linestyle=linestyles[0], color='black', label='HNO4')
    ...
    ax[1].plot(mr_z_s_new[:,ind_n2o5], z_center_new, linewidth=2, linestyle=linestyles[1], color='mediumorchid')   
    ax[1].plot(mr_z_s_new[:,ind_hno4], z_center_new, linewidth=2, linestyle=linestyles[1], color='black')   
...
####Final grid for paper
plot_comparison('./scenario_library/Sun/CO2-Full-CO-NO/ConcentrationSTD.dat', './scenario_library/TRAPPIST-1/CO2-Full-CO-NO/ConcentrationSTD.dat', 'Sun-TRAPPIST_CO2-Full-CO-NO') #0, 1
plot_comparison('./scenario_library/TRAPPIST-1/CO2-Full-CO-NO/ConcentrationSTD.dat', './scenario_library/TRAPPIST-1/CO2-Cut-CO-NO/ConcentrationSTD.dat', 'TRAPPIST_CO2-Full-Cut') #2
plot_comparison('./scenario_library/TRAPPIST-1/CO2-Full-CO-NO/ConcentrationSTD.dat', './scenario_library/TRAPPIST-1/CO2/ConcentrationSTD.dat', 'TRAPPIST_CO2-Full-noN') #3
plot_comparison('./scenario_library/TRAPPIST-1/CO2/ConcentrationSTD.dat', './scenario_library/TRAPPIST-1/CO2-noS/ConcentrationSTD.dat', 'TRAPPIST_CO2-noS') #4
plot_comparison('./scenario_library/TRAPPIST-1/CO2-noS/ConcentrationSTD.dat', './scenario_library/TRAPPIST-1/CO2-noS-bigzgrid/ConcentrationSTD.dat', 'TRAPPIST-1_CO2-noS_bigzgrid') #5
plot_comparison('./scenario_library/TRAPPIST-1/CO2-noS/ConcentrationSTD.dat', './scenario_library/TRAPPIST-1/CO2-noS-truncatestellar/ConcentrationSTD.dat', 'TRAPPIST-1_CO2-noS_truncatestellar') #6
plot_comparison('./scenario_library/TRAPPIST-1/CO2-noS-bigzgrid/ConcentrationSTD.dat', './scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/ConcentrationSTD.dat', 'TRAPPIST-1_CO2-noS-bigzgrid_truncatestellar') #7
plot_comparison('./scenario_library/GJ876/N2_CO2-Full-CO-NO/ConcentrationSTD.dat', './scenario_library/GJ876/N2_CO2-Cut-CO-NO/ConcentrationSTD.dat', 'GJ876_N2_CO2_Full_Cut') #10,11
plot_comparison('./scenario_library/TRAPPIST-1/CO2-noS/ConcentrationSTD.dat', './scenario_library/TRAPPIST-1/CO2-noS-highres/ConcentrationSTD.dat', 'TRAPPIST-1_CO2-noS_highres') #12
plot_comparison('./scenario_library/TRAPPIST-1/CO2-noS/ConcentrationSTD.dat', './scenario_library/TRAPPIST-1/CO2-noS-highKzz/ConcentrationSTD.dat', 'TRAPPIST-1_CO2-noS_highKzz') #13
plot_comparison('./scenario_library/TRAPPIST-1/CO2-noS-bigzgrid/ConcentrationSTD.dat', './scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowKzz/ConcentrationSTD.dat', 'TRAPPIST-1_CO2-noS-bigzgrid_lowKzz') #14
plot_comparison('./scenario_library/TRAPPIST-1/CO2-noS-bigzgrid/ConcentrationSTD.dat', './scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/ConcentrationSTD.dat', 'TRAPPIST-1_CO2-noS-bigzgrid_lowresz') #15
plot_comparison('./scenario_library/TRAPPIST-1/CO2-noS-bigzgrid/ConcentrationSTD.dat', './scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-highres/ConcentrationSTD.dat', 'TRAPPIST-1_CO2-noS-bigzgrid_highres')
