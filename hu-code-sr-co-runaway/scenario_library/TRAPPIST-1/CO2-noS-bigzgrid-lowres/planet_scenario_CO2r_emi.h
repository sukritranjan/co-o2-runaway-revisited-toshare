...
/* Calculation Grids*/
#define zbin 20 /*How many altitude bin?*/
...
#define SPECIES_LIST "scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/species_scenario_CO2N2r_emi.dat"
...
#define IMPORTFILEX "scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/Conx.dat" /* File of concentrations X to be imported */
#define IMPORTFILEF "scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/Conf.dat" /* File of concentrations F to be imported */       
...
/* Output Options */
#define OUT_FILE1			"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/Conx.dat"
#define OUT_FILE2			"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/Conf.dat"
#define OUT_HISTORY			"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/History.dat"
#define OUT_PHOTORATE		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/Photorate.dat"
#define OUT_CHEMICALRATE	"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/ChemicalRate.dat"
#define OUT_CONVERGENCE		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/Convergence.dat"
#define OUT_TIMESCALE		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/Timescale.dat"
#define OUT_COLUMN			"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/ColumnDensity.dat"
#define OUT_STD				"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/ConcentrationSTD.dat"
#define OUT_BALANCE			"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/GlobalBalance.dat"
#define OUT_RADIATION		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/Radiation.dat"
#define OUT_MEANOPAC		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/MeanOpacity.dat"
#define OUT_NEWTEMP			"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/NewTemperature.dat"
...
#define UVRFILE			"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/Reflection.dat"  /* Output spectrum file name */
#define UVRFILEVar1		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/ReflectionVar1.dat"  /* Output spectrum file name */
#define UVRFILEVar2		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/ReflectionVar2.dat"  /* Output spectrum file name */
#define UVRFILEVar3		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/ReflectionVar3.dat"  /* Output spectrum file name */
#define UVRFILEVar4		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/ReflectionVar4.dat"  /* Output spectrum file name */
#define UVROPTFILE		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/UVROpt.dat" /* Output spectrum file name*/

/* Stellar Light Transmission output options */
#define UVTFILE			"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/Transmission.dat" /* Output spectrum file name */
#define UVTFILEVar1		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/TransmissionVar1.dat" /* Output spectrum file name */
#define UVTFILEVar2		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/TransmissionVar2.dat" /* Output spectrum file name */
#define UVTFILEVar3		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/TransmissionVar3.dat" /* Output spectrum file name */
#define UVTFILEVar4		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/TransmissionVar4.dat" /* Output spectrum file name */
#define UVTOPTFILE		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/UVTOpt.dat" /* Output spectrum file name*/

/* Thermal Emission output options */
#define IRFILE			"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/Emission.dat"	     /* Output spectrum file name */
#define IRFILEVar1		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/EmissionVar1.dat"	 /* Output spectrum file name */
#define IRFILEVar2		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/EmissionVar2.dat"	 /* Output spectrum file name */
#define IRFILEVar3		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/EmissionVar3.dat"	 /* Output spectrum file name */
#define IRFILEVar4		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/EmissionVar4.dat"	 /* Output spectrum file name */
#define IRCLOUDFILE		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-lowres/CloudTopE.dat"      /* Output emission cloud top file name */
