...
#define TPLIST                 "Data/TP_pCO2=0.03_pN2=0.97_Tstrat=175K.dat"
...
#define SPECIES_LIST "scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/species_scenario_CO2N2r_emi.dat"
...
#define IMPORTFILEX "scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/Conx.dat" /* File of concentrations X to be imported */
#define IMPORTFILEF "scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/Conf.dat" /* File of concentrations F to be imported */       
...
#define KET1 1.0E+6
#define KEH1 1.0E+8
#define EDDYIMPORT	"Data/Eddy_pCO2=0.03_pN2=0.97_Tstrat=175K.dat"
...
/* Output Options */
#define OUT_FILE1			"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/Conx.dat"
#define OUT_FILE2			"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/Conf.dat"
#define OUT_HISTORY			"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/History.dat"
#define OUT_PHOTORATE		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/Photorate.dat"
#define OUT_CHEMICALRATE	"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/ChemicalRate.dat"
#define OUT_CONVERGENCE		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/Convergence.dat"
#define OUT_TIMESCALE		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/Timescale.dat"
#define OUT_COLUMN			"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/ColumnDensity.dat"
#define OUT_STD				"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/ConcentrationSTD.dat"
#define OUT_BALANCE			"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/GlobalBalance.dat"
#define OUT_RADIATION		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/Radiation.dat"
#define OUT_MEANOPAC		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/MeanOpacity.dat"
#define OUT_NEWTEMP			"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/NewTemperature.dat"
...
#define UVRFILE			"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/Reflection.dat"  /* Output spectrum file name */
#define UVRFILEVar1		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/ReflectionVar1.dat"  /* Output spectrum file name */
#define UVRFILEVar2		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/ReflectionVar2.dat"  /* Output spectrum file name */
#define UVRFILEVar3		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/ReflectionVar3.dat"  /* Output spectrum file name */
#define UVRFILEVar4		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/ReflectionVar4.dat"  /* Output spectrum file name */
#define UVROPTFILE		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/UVROpt.dat" /* Output spectrum file name*/

/* Stellar Light Transmission output options */
#define UVTFILE			"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/Transmission.dat" /* Output spectrum file name */
#define UVTFILEVar1		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/TransmissionVar1.dat" /* Output spectrum file name */
#define UVTFILEVar2		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/TransmissionVar2.dat" /* Output spectrum file name */
#define UVTFILEVar3		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/TransmissionVar3.dat" /* Output spectrum file name */
#define UVTFILEVar4		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/TransmissionVar4.dat" /* Output spectrum file name */
#define UVTOPTFILE		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/UVTOpt.dat" /* Output spectrum file name*/

/* Thermal Emission output options */
#define IRFILE			"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/Emission.dat"	     /* Output spectrum file name */
#define IRFILEVar1		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/EmissionVar1.dat"	 /* Output spectrum file name */
#define IRFILEVar2		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/EmissionVar2.dat"	 /* Output spectrum file name */
#define IRFILEVar3		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/EmissionVar3.dat"	 /* Output spectrum file name */
#define IRFILEVar4		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/EmissionVar4.dat"	 /* Output spectrum file name */
#define IRCLOUDFILE		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-pCO2=0.03/CloudTopE.dat"      /* Output emission cloud top file name */
