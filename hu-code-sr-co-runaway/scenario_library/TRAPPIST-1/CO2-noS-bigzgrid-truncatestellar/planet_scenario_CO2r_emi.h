...
#define STAR_SPEC           "Data/trappist-1_120nm.txt"
...
#define SPECIES_LIST "scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/species_scenario_CO2N2r_emi.dat"
...
#define IMPORTFILEX "scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/Conx.dat" /* File of concentrations X to be imported */
#define IMPORTFILEF "scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/Conf.dat" /* File of concentrations F to be imported */       
...
/* Reaction Zones */
#define REACTION_LIST "Data/zone_scenario_CO2N2r.dat"
...
/* Output Options */
#define OUT_FILE1			"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/Conx.dat"
#define OUT_FILE2			"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/Conf.dat"
#define OUT_HISTORY			"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/History.dat"
#define OUT_PHOTORATE		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/Photorate.dat"
#define OUT_CHEMICALRATE	"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/ChemicalRate.dat"
#define OUT_CONVERGENCE		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/Convergence.dat"
#define OUT_TIMESCALE		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/Timescale.dat"
#define OUT_COLUMN			"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/ColumnDensity.dat"
#define OUT_STD				"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/ConcentrationSTD.dat"
#define OUT_BALANCE			"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/GlobalBalance.dat"
#define OUT_RADIATION		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/Radiation.dat"
#define OUT_MEANOPAC		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/MeanOpacity.dat"
#define OUT_NEWTEMP			"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/NewTemperature.dat"
...
#define CROSSHEADING		"Cross3/CO2Atmos/"
...
#define UVRFILE			"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/Reflection.dat"  /* Output spectrum file name */
#define UVRFILEVar1		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/ReflectionVar1.dat"  /* Output spectrum file name */
#define UVRFILEVar2		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/ReflectionVar2.dat"  /* Output spectrum file name */
#define UVRFILEVar3		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/ReflectionVar3.dat"  /* Output spectrum file name */
#define UVRFILEVar4		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/ReflectionVar4.dat"  /* Output spectrum file name */
#define UVROPTFILE		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/UVROpt.dat" /* Output spectrum file name*/

/* Stellar Light Transmission output options */
#define UVTFILE			"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/Transmission.dat" /* Output spectrum file name */
#define UVTFILEVar1		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/TransmissionVar1.dat" /* Output spectrum file name */
#define UVTFILEVar2		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/TransmissionVar2.dat" /* Output spectrum file name */
#define UVTFILEVar3		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/TransmissionVar3.dat" /* Output spectrum file name */
#define UVTFILEVar4		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/TransmissionVar4.dat" /* Output spectrum file name */
#define UVTOPTFILE		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/UVTOpt.dat" /* Output spectrum file name*/

/* Thermal Emission output options */
#define IRFILE			"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/Emission.dat"	     /* Output spectrum file name */
#define IRFILEVar1		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/EmissionVar1.dat"	 /* Output spectrum file name */
#define IRFILEVar2		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/EmissionVar2.dat"	 /* Output spectrum file name */
#define IRFILEVar3		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/EmissionVar3.dat"	 /* Output spectrum file name */
#define IRFILEVar4		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/EmissionVar4.dat"	 /* Output spectrum file name */
#define IRCLOUDFILE		"scenario_library/TRAPPIST-1/CO2-noS-bigzgrid-truncatestellar/CloudTopE.dat"      /* Output emission cloud top file name */
